...
# Date  : 2025-08-29
#
# monitor electrical input power from netextreme power supply units (PSU)
...
snmp_section_netextreme_psu_in = SimpleSNMPSection(
    name = "netextreme_psu_in_base_config",
...
check_plugin__netextreme_psu_in = CheckPlugin(
    name = "netextreme_psu_in",
    sections = ["netextreme_psu_in_base_config"],
    service_name = "Power Supply Input %s",
