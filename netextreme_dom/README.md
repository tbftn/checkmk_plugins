[PACKAGE]: packages/netextreme_dom-0.1.2.mkp "netextreme_dom-0.1.2.mkp"
...
## Check information
Creates one service **DOM Port** per installed SFP and each Channel with DOM functionality. DOMs are only recognized if the corresponding interface is not in AdminStatus 2 (disabled)
